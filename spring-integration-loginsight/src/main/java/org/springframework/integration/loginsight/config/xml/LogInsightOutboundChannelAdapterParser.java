...
/**
 * The parser for the LogInsight Outbound Channel Adapter.
 *
 ...
 *
 */
public class LogInsightOutboundChannelAdapterParser extends AbstractOutboundChannelAdapterParser {
	...
	protected AbstractBeanDefinition parseConsumer(Element element, ParserContext parserContext) {
		...
		BeanDefinitionBuilder logInsightOutboundChannelAdapterBuilder = BeanDefinitionBuilder
				.genericBeanDefinition(LogInsightOutboundChannelAdapter.class);
		...
		if (StringUtils.hasText(templateName)) {
			...
			logInsightOutboundChannelAdapterBuilder.addConstructorArgReference(templateName);
		}

		logInsightOutboundChannelAdapterBuilder.addPropertyValue("producesReply", Boolean.FALSE);

		return logInsightOutboundChannelAdapterBuilder.getBeanDefinition();
