...
public class LogInsightServerParserTests {
	...
	public void testDoParseElementParserContextBeanDefinitionBuilder() {
		LogInsightServer server = appContext.getBean("logInsightTestServer", LogInsightServer.class);

		Assert.assertEquals("test.loginsight.server", server.getHost());
		Assert.assertEquals(9000, server.getPort());
